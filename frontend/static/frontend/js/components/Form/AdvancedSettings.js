                ...
                <div className="card z-depth-0 bordered">
                    <div className="card-header" id="headingAdvanced">
                        <h5 className="mb-0 text-center">
                            <Button className="btn btn-link" color='none' id='show-advanced' type="button" data-toggle="collapse" data-target="#advanced" aria-expanded="true" aria-controls="advanced" onClick={this.toggleCollapse}>
                                Advanced settings
                            </Button>
                        </h5>
                    </div>
                    <Collapse id="advanced" aria-labelledby="headingAdvanced" data-parent="#accordionAdvanced" isOpen={this.state.isOpen}>
                                    ...
                                    <div className='col'>
                                        ...
                                        >
                                            {this.props.expressionList.map((exp, i) =>
                                                <option value={exp} key={i}>{exp}</option>
                                            )}
                                        </select>
                                    </div>
                                </div>
