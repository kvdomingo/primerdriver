...
import SequenceInput from './Form/ProteinSequenceInput';
...
export default withRouter(class DnaView extends Component {
    ...
    handleChange(e) {
		...
		if (name === 'sequence' || name === 'target' || name === 'replacement') {
			let sequence = value
	            .toUpperCase()
	            .split("");
            let aminoAcids = ['A', 'R', 'N', 'D', 'B', 'C', 'E', 'Q', 'Z', 'G', 'H', 'I', 'L', 'K', 'M', 'F', 'P', 'S', 'T', 'W', 'Y', 'V'];
    ...
    render() {
        if (this.state.loading) return (<LoadingScreen />);
            ...
            <Form title='Protein-based Primer Design' handleValidate={this.validateForm} handleSubmit={this.handleSubmit} handleReset={this.handleReset} {...this.state}>
