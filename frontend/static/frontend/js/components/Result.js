...
export default class Result extends Component {
        ...
        return (
            <div>
                <Link
                    ...
                    id='back'
                    >
                    <Icon fas icon='arrow-left' className='mr-3' />main menu
                </Link>
    ...
    render() {
        if (typeof(this.props.results) === 'object') {
            if (this.props.mode === 'CHAR') return (
                    <div>
                        {this.header()}
            ...
            return (
                <div className='text-center'>
                    {this.header()}
                    <p>Oops! Something went wrong on the server. Please try again later, or <a href='https://github.com/kvdomingo/primerdriver/issues' target='_blank' rel='noopener noreferrer'>report an issue</a>.</p>
                </div>
            );
        }
    }
