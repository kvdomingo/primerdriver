...
class WebTestCase(StaticLiveServerTestCase):
    ...
    def test_submit_disabled_on_characterize_landing(self):
        self.selenium.get(self.live_server_url)
        goto_char = self.selenium.find_element_by_id('characterize')
        goto_char.click()
    ...
    def test_submit_disabled_on_type_sequence(self):
        self.selenium.get(self.live_server_url)
        goto_char = self.selenium.find_element_by_id('characterize')
        goto_char.click()
    ...
    def test_submit_disabled_on_set_mismatch(self):
        self.selenium.get(self.live_server_url)
        goto_char = self.selenium.find_element_by_id('characterize')
        goto_char.click()
        textarea = self.selenium.find_element_by_id('sequence')
    ...
    def test_submit_enabled_on_set_mutation(self):
        self.selenium.get(self.live_server_url)
        goto_char = self.selenium.find_element_by_id('characterize')
        goto_char.click()
        textarea = self.selenium.find_element_by_id('sequence')
    ...
    def test_submit_disabled_on_form_reset(self):
        self.selenium.get(self.live_server_url)
        goto_char = self.selenium.find_element_by_id('characterize')
        goto_char.click()
        textarea = self.selenium.find_element_by_id('sequence')
